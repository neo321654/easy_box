...
abstract class InventoryRepository {
  ...
  Future<Either<Failure, OperationResult>> addStock(String sku, int quantityToAdd);
  Future<Either<Failure, OperationResult>> createProduct({required String name, required String sku, String? location, String? imageUrl});
