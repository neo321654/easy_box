...
Future<void> init({Locale? systemLocale}) async {
  ...
  final List<ProductModel> initialMockProducts = [
    const ProductModel(id: '1', name: 'Red T-Shirt, Size L', sku: 'SKU-TS-RED-L', quantity: 150, location: 'A1-01-01', imageUrl: 'https://picsum.photos/id/10/200/200'),
    const ProductModel(id: '2', name: 'Blue Jeans, Size 32', sku: 'SKU-JN-BLU-32', quantity: 85, location: 'A1-01-02', imageUrl: 'https://picsum.photos/id/20/200/200'),
    const ProductModel(id: '3', name: 'Green Hoodie, Size M', sku: 'SKU-HD-GRN-M', quantity: 110, location: 'A2-03-05', imageUrl: 'https://picsum.photos/id/30/200/200'),
    const ProductModel(id: '4', name: 'Black Sneakers, Size 42', sku: 'SKU-SN-BLK-42', quantity: 200, location: 'C4-02-01', imageUrl: 'https://picsum.photos/id/40/200/200'),
    const ProductModel(id: '5', name: 'White Socks (3-pack)', sku: 'SKU-SK-WHT-3P', quantity: 350, location: 'C4-02-02', imageUrl: 'https://picsum.photos/id/50/200/200'),
  ];
  ...
  final appDb = await openDatabase(
    ...
    onCreate: (db, version) {
      ...
      db.execute(
        'CREATE TABLE product_creations_queue(id INTEGER PRIMARY KEY AUTOINCREMENT, name TEXT, sku TEXT, location TEXT, local_id TEXT, timestamp INTEGER, image_url TEXT)',
      );
      db.execute(
        'CREATE TABLE product_updates_queue(id INTEGER PRIMARY KEY AUTOINCREMENT, product_id TEXT, name TEXT, sku TEXT, quantity INTEGER, location TEXT, timestamp INTEGER, image_url TEXT)',
      );
      db.execute(
    ...
    onUpgrade: (db, oldVersion, newVersion) {
      ...
      if (oldVersion < 6) {
        ...
        db.execute('ALTER TABLE product_creations_queue ADD COLUMN image_url TEXT');
        db.execute('ALTER TABLE product_updates_queue ADD COLUMN image_url TEXT');
      }
    },
  );
